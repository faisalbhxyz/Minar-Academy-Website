...
export default function NewsLetter() {
  return (
    <div className="px-3">
      <div className="w-full max-w-[1400px] mx-auto p-6 sm:p-10 bg-black text-white my-20 flex flex-col md:flex-row items-center justify-between rounded-3xl gap-10">
