...
**Related:** [LESSON_VIDEO_PROGRESS_STOREFRONT_API.md](./LESSON_VIDEO_PROGRESS_STOREFRONT_API.md)
...
**Mobile wiring:** `mobile/src/lib/freeLessons.ts` + `mobile/src/api/index.ts` (`fetchFreeLessonsCatalog`, `fetchMyFreeLessons`, `addMyFreeLessons`, `removeMyFreeLesson`).
